...
parser = argparse.ArgumentParser(description='Calculate dense neural network accuracies on overrepresented genera, and compare with PlasFlow and PlasClass predictions')
